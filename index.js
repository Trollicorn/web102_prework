...
let unfundedStr = `A total of $${raised.toLocaleString("en-US")} has been raised for
                    ${GAMES_JSON.length} ${GAMES_JSON.length == 1 ? "game" : "games"}.
                    Currently, ${numUnfunded} ${numUnfunded == 1 ? "game remains" : "games remain"}
                    unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
let remainUnfunded = document.createElement("p");
remainUnfunded.innerHTML = unfundedStr;
descriptionContainer.append(remainUnfunded);
